...
const cart = {
  ...
  // Добавляем товар. Создаем новый объект, передаем в него свойство и значения,
  // пушим в массив items.
  // Прибавляем к общей стоимости корзины стоимость товаров,
  ...
  calculateItemPrice() {
    this.totalPrice = this.items.reduce(
        (acc, item) => acc + item.price * item.countGoods, 0
    );
